...
# Test drawing on repeat for a length of time. 
# 
...
while True:
    ...
    for infile in files: 
        ...
        print(f"======== RENDERING DRAWING #{filescount} ========")
        # ==== Wrangle pen paths ====
    ...
    sys.stdout.flush()
    code = arm.set_servo_angle(angle=lookforward, speed=liftSpeed, mvacc=params['acc'], wait=True, radius=-1.0)
